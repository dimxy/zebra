...
use zebra_chain::{
    block::{self, Height},
    transparent::EXTRA_ZEBRA_COINBASE_DATA, parameters::Network,
};
...
use super::{finalized_state, read};
...
fn update_latest_chain_channels(
    ...
    let tip_block = best_chain
        ...
        .clone();
    let mut tip_block = ChainTipBlock::from(tip_block);
    ...
    tip_block.mtp = median_time_past;
