...
use zebra_consensus::{
    funding_stream_address, funding_stream_values, height_for_first_halving, komodo_miner_subsidy,
    VerifyChainError,
};
    ...
    // AddressBook: AddressBookPeers + Clone + Send + Sync + 'static,
{
    ...
    fn get_block_subsidy(&self, height: Option<u32>) -> BoxFuture<Result<BlockSubsidy>> {
        ...
        async move {
            ...
            let (_receivers, funding_streams): (Vec<_>, _) = funding_streams.into_iter().collect().unzip();
            */
